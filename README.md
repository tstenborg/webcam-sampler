...
Automated sampling of webcam imaging was investigated as a means of meteor data collection. A sampling system was developed in Excel with Visual Basic for Applications (VBA), the scripting language built into Microsoft's Office suite.
...
Additionally, ensure Windows isn't also blocking the workbook's macros. To resolve this, right click on the file to open the file's Properties. Go to the General tab, Security section and select the Unblock checkbox.
